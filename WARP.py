...
import os
import sys
os.system("𝐖𝐀𝐑𝐏+  𝐒𝐂𝐑𝐈𝐏𝐓" + " 𝐌𝐀𝐃𝐄 𝐁𝐘 ​̲𝙋​̲𝙧​̲𝙤​̲𝙛​̲𝙚​̲𝙨​̲𝙨​̲𝙤​̲𝙧​̲ ​̲𝙍​̲𝙖​̲𝙩​̲𝙪​̲𝙡)
os.system('cls' if os.name == 'nt' else 'clear')
#__________________[ SYS ]__________________#
sys.stdout.write('\x1b]2;)☢️WARP ☣️FREE♻️ GP🔰\x07')
print("                 \033[45m𝐖𝐀𝐑𝐏+  𝐒𝐂𝐑𝐈𝐏𝐓" + " 𝐌𝐀𝐃𝐄 𝐁𝐘 ​̲𝙋​̲𝙧​̲𝙤​̲𝙛​̲𝙚​̲𝙨​̲𝙨​̲𝙤​̲𝙧​̲ ​̲𝙍​̲𝙖​̲𝙩​̲𝙪​̲𝙡\033[40m")
print("""\033[32m
...
while True:
	...
	if result == 200:
		...
		print("[*] ⏸️\033[43m𝐀𝐟𝐭𝐞𝐫 𝟭𝟴 𝐒𝐞𝐜𝐨𝐧𝐝𝐬, 𝐀 𝐍𝐞𝐰 𝐑𝐞𝐪𝐮𝐞𝐬𝐭 𝐖𝐢𝐥𝐥 𝐁𝐞 𝐒𝐞𝐧𝐭\033[40m.")
		print("""\033[36
▒██   ██▒▓██   ██▓ ██▓     ▒█████   ███▄    █ 
▒▒ █ █ ▒░ ▒██  ██▒▓██▒    ▒██▒  ██▒ ██ ▀█   █ 
░░  █   ░  ▒██ ██░▒██░    ▒██░  ██▒▓██  ▀█ ██▒
